...
{
	// Player
	IMAGEMANAGER->addFrameImage(ImageName::playerIdle, PATH_UNIT"Player/Idle.bmp", 390, 150, 5, 2, true, ColorSet::MAGENTA);
	IMAGEMANAGER->addFrameImage(ImageName::playerRun, PATH_UNIT"Player/Run.bmp", 624, 150, 8, 2, true, ColorSet::MAGENTA);
	IMAGEMANAGER->addImage(ImageName::playerDie, PATH_UNIT"Player/Die.bmp", 78, 75, true, ColorSet::MAGENTA);
