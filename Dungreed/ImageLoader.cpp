...
void ImageLoader::loadImages()
{
	...
	// MapTool
	IMAGEMANAGER->addFrameImage("MapTile", PATH_IMAGE"MapTool/MapTile.bmp", 1024 * TILE_SCALE, 512 * TILE_SCALE, 64, 32, true, MAGENTA);
	IMAGEMANAGER->addFrameImage("MapToolTile", PATH_IMAGE"MapTool/MapTile.bmp", 1024 * TILE_SCALE_MAPTOOL, 512 * TILE_SCALE_MAPTOOL, 64, 32, true, MAGENTA);
