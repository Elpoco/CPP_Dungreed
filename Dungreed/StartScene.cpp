...
void StartScene::loadImage(void)
{
	...
	IMAGEMANAGER->addImage("Tile1", PATH_IMAGE"Map/Tile1.bmp", 160, 160, true, MAGENTA);
	IMAGEMANAGER->addImage("Tile2", PATH_IMAGE"Map/Tile2.bmp", 160, 160, true, MAGENTA);
	IMAGEMANAGER->addImage("Tile3", PATH_IMAGE"Map/Tile3.bmp", 160, 160, true, MAGENTA);
