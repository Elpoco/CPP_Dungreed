...
public:
	...
	void drawNumber(HDC hdc, int destX, int destY, int fontSize, int fontWidth, const char* str, COLORREF color = ColorSet::BLACK);
	void drawNumber(HDC hdc, int destX, int destY, int fontSize, int fontWidth, LPCWSTR str, COLORREF color = ColorSet::BLACK);
	
	void drawString(HDC hdc, int destX, int destY, int fontSize, int fontWidth, const char* str, COLORREF color = ColorSet::BLACK);
