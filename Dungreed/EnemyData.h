...
public:
	EnemyData()
	{
		...
		// 보스
		_info[TO_INT(Code::UNIT::BELIAL)]				= { Code::UNIT::BELIAL, "벨리알", 200 };
		_info[TO_INT(Code::UNIT::NIFLEHEIM)]			= { Code::UNIT::NIFLEHEIM, "니플헤임", 200 };
		_info[TO_INT(Code::UNIT::NIFLEHEIM_PILLAR)]		= { Code::UNIT::NIFLEHEIM_PILLAR, "얼음 기둥", 50 };
	}
	~EnemyData() {}
